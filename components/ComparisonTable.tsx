    ...
    <div className="bg-white border overflow-hidden rounded-2xl shadow-lg my-6 border-gray-100">
      <div className="p-4 border-b border-gray-50 flex items-center justify-between" style={{ backgroundColor: `${accentColor}05` }}>
        <h3 className="font-bold text-gray-800 flex items-center">
          ...
          Confronto Destinazioni Proposte
        </h3>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50/50">
              <th className="px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider border-b border-gray-50">Dettaglio</th>
              {data.destinations.map((d, i) => (
                <th key={i} className="px-4 py-3 text-sm font-bold text-gray-800 border-b border-gray-50 min-w-[140px]">
                  {d.name === data.destinations[0].name && (
          ...
          <tbody className="text-xs">
            <tr>
              <td className="px-4 py-3 font-semibold text-gray-500 border-b border-gray-50">Affinità</td>
              {data.destinations.map((d, i) => (
            ...
            <tr>
              <td className="px-4 py-3 font-semibold text-gray-500 border-b border-gray-50">Prezzo</td>
              {data.destinations.map((d, i) => (
            ...
            <tr>
              <td className="px-4 py-3 font-semibold text-gray-500 border-b border-gray-50">Periodo</td>
              {data.destinations.map((d, i) => (
            ...
            <tr className="bg-gray-50/20">
              <td className="px-4 py-4 font-semibold text-gray-500 flex flex-col items-start h-full">Perché per te</td>
              {data.destinations.map((d, i) => (
